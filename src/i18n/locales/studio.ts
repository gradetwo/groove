export const studioMessages = {
  ...
  toolbar_arrangement_title: { en: "Open the arrangement view", zh: "打开编排视图" },
  toolbar_arrangement_label: { en: "ARRANGE", zh: "编排" },
  arrangement_title: { en: "Arrangement", zh: "编排视图" },
  arrangement_hint: {
    en: "Drag a region to move it, drag its right edge to repeat it. Arrow keys move, Shift+arrows resize, Ctrl/Cmd+D duplicates, Delete removes.",
    zh: "拖动区域可移动，拖右边缘可改重复次数。方向键移动，Shift+方向键改长度，Ctrl/Cmd+D 复制，Delete 删除。",
  },
  arrangement_close: { en: "Close the arrangement view", zh: "关闭编排视图" },
  arrangement_empty: {
    en: "No sections yet — the sequencer's song chain creates them.",
    zh: "还没有段落——在音序器的歌曲链里添加。",
  },
  arrangement_problems: { en: "Will not play:", zh: "不会播放：" },
  arrangement_section_word: { en: "Section", zh: "段落" },
  arrangement_select_hint: { en: "Select a region to edit it", zh: "选择一个区域以编辑" },
  arrangement_selected: { en: "Selected: {name} · {bars} bars", zh: "已选：{name} · {bars} 小节" },
  arrangement_region_aria: {
    en: "Section {name}, clip {slot}, {bars} bars",
    zh: "段落 {name}，片段 {slot}，{bars} 小节",
  },
  arrangement_resize_aria: { en: "Change how many bars {name} repeats", zh: "改变段落 {name} 的重复小节数" },
  arrangement_grow: { en: "+1 bar", zh: "加 1 小节" },
  ...
  arrangement_transpose_hint: { en: "Move this section's pitched lanes by {semitones}", zh: "把本段落的音高轨移动 {semitones} 个半音" },
  arrangement_transpose_value: { en: "{semitones} st", zh: "{semitones} 半音" },
  ...
  roll_kb_help: {
    en: "Piano roll keyboard: arrow keys move the cursor (hold Shift for a bar or an octave), Home and End jump to the first and last step, Enter adds or removes a note, Delete removes it, plus or minus changes its velocity, and square brackets change its length (hold Shift for ten or for a beat).",
    zh: "钢琴卷帘键盘操作：方向键移动光标（按住 Shift 跨小节或八度），Home / End 跳到首尾步，Enter 添加或删除音符，Delete 删除，加号 / 减号调整力度，方括号调整音长（按住 Shift 为十或一拍）。",
  },
  roll_kb_cursor_empty: {
    en: "{note} · step {step} · empty",
    zh: "{note} · 第 {step} 步 · 空",
  },
  roll_kb_cursor_note: {
    en: "{note} · step {step} · velocity {velocity}",
    zh: "{note} · 第 {step} 步 · 力度 {velocity}",
  },
  roll_kb_added: { en: "Added {note} · step {step}", zh: "已添加 {note} · 第 {step} 步" },
  roll_kb_removed: { en: "Removed {note} · step {step}", zh: "已删除 {note} · 第 {step} 步" },
  roll_kb_velocity: { en: "{note} velocity {velocity}", zh: "{note} 力度 {velocity}" },
  roll_kb_velocity_many: {
    en: "{count} notes · velocity {velocity}",
    zh: "{count} 个音 · 力度 {velocity}",
  },
