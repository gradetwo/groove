...
export const GENRE_MIX: Record<string, GenreMix> = {
  ...
  "acid-house": { category: "Electronic", loudnessTrimDb: -4.74 },
  "acid-techno": { category: "Electronic", loudnessTrimDb: -3.48 },
  ...
  "brostep": { humanise: 0.12, category: "Electronic", loudnessTrimDb: -2.45, overrides: { kick: { volume: 0.98 }, bass: { volume: 0.98, sendA: 0.0 } }  }, // see dubstep
  ...
  "chicago-house": { category: "Electronic", loudnessTrimDb: -4.09, overrides: { snare: { volume: 0.86, sendA: 0.14 }, chords: { volume: 0.78, sendA: 0.18 } } },
  ...
  "detroit-techno": { category: "Electronic", loudnessTrimDb: -4.33, overrides: { chords: { volume: 0.8, pan: -0.18, sendA: 0.2 }, lead: { volume: 0.74 } } },
  ...
  "drift-phonk": { humanise: 0.08, category: "Electronic", loudnessTrimDb: -0.02, overrides: { kick: { volume: 1.0 }, bass: { volume: 0.98 } }  }, // phonk is deliberately flat and loud — that is the aesthetic
  ...
  "dubstep": { humanise: 0.12, category: "Electronic", loudnessTrimDb: 0.76, overrides: { kick: { volume: 0.98 }, snare: { volume: 0.72 }, bass: { volume: 0.99 }, chords: { volume: 0.6 }, lead: { volume: 0.64 }, fx: { volume: 0.6 } }  }, // the dynamics live in the sound design, not in the lane levels
  ...
  "electro-house": { category: "Electronic", loudnessTrimDb: -1.53, overrides: { kick: { volume: 0.98 }, lead: { volume: 0.86, pan: 0.18 } } },
  "euro-trance": { category: "Electronic", loudnessTrimDb: -5.96, overrides: { lead: { volume: 0.9, sendA: 0.26 }, chords: { volume: 0.8, sendA: 0.28 }, fx: { volume: 0.72 } } },
  "footwork": { humanise: 0.12, category: "Electronic", loudnessTrimDb: -5.33, overrides: { kick: { volume: 0.98 }, snare: { volume: 0.8 }, hihat: { volume: 0.84, pan: -0.38 }, percussion: { volume: 0.8 } }, duck: { duckDb: 6.5, releaseMs: 80 } }, // at 160 BPM any humanisation reads as a mistake, not as feel · 160 BPM footwork: punch, not a swell
  "frenchcore": { humanise: 0.07, category: "Electronic", loudnessTrimDb: -0.03, overrides: { kick: { volume: 1.0 }, lead: { volume: 0.72 }, fx: { volume: 0.5 } }, duck: { duckDb: 7, releaseMs: 70 } }, // same as gabber: the kick is the genre, and it does not move · see hardcore-gabber — the tempo sets the release
  "french-house": { category: "Electronic", loudnessTrimDb: -0.06, overrides: { bass: { volume: 0.94 }, chords: { volume: 0.8, sendA: 0.18 }, lead: { volume: 0.76, sendB: 0.22 } } },
  ...
  "future-house": { category: "Electronic", loudnessTrimDb: -1.51, overrides: { bass: { volume: 0.94 }, lead: { volume: 0.82, sendA: 0.2 } } },
  ...
  "happy-hardcore": { category: "Electronic", loudnessTrimDb: -3.09, overrides: { kick: { volume: 0.98 }, lead: { volume: 0.86 }, chords: { volume: 0.78, sendA: 0.2 } } },
  "hardcore-gabber": { humanise: 0.07, category: "Electronic", loudnessTrimDb: -0.08, overrides: { kick: { volume: 1.0 }, snare: { volume: 0.7 }, bass: { volume: 0.94 } }, duck: { duckDb: 7, releaseMs: 70 } }, // the genre is defined by its machine-straight kick · a 170+ BPM kick arrives every ~170 ms, so the duck must clear before the next one
  "hardstyle": { humanise: 0.09, category: "Electronic", loudnessTrimDb: -4.97, overrides: { kick: { volume: 1.0 }, bass: { volume: 0.98 }, lead: { volume: 0.82 }, fx: { volume: 0.6 } }, duck: { duckDb: 7, releaseMs: 80 } }, // the reverse bass and kick are programmed, not played · the reverse bass is re-triggered on every kick, so the duck clears fast
  "hard-techno": { humanise: 0.1, category: "Electronic", loudnessTrimDb: -4.87, overrides: { kick: { volume: 1.0 }, bass: { volume: 0.95 }, snare: { volume: 0.86 } }, duck: { duckDb: 6.5, releaseMs: 110 } }, // industrial-weight techno: a flat kick is the point · harder and faster than the category base
  ...
  "industrial-techno": { humanise: 0.1, category: "Electronic", loudnessTrimDb: -4.9, overrides: { kick: { volume: 1.0 }, bass: { volume: 0.95 }, snare: { volume: 0.88 } }, duck: { duckDb: 6.5, releaseMs: 110 } }, // see hard-techno — the machine aesthetic is the genre · see hard-techno
  ...
  "jersey-drill": { category: "Electronic", loudnessTrimDb: -3.73, overrides: { kick: { volume: 0.98 }, bass: { volume: 0.98 }, hihat: { volume: 0.82, pan: -0.4 }, percussion: { volume: 0.78 } } },
  ...
  "lofi-house": { category: "Electronic", loudnessTrimDb: -6.03, overrides: { hihat: { volume: 0.58 }, chords: { volume: 0.84, sendA: 0.24 }, lead: { volume: 0.66, sendA: 0.22 }, fx: { volume: 0.34 } } },
  ...
  "neurofunk": { category: "Electronic", loudnessTrimDb: -3.09, overrides: { kick: { volume: 0.96 }, snare: { volume: 0.92 }, bass: { volume: 1.0 } } },
  ...
  "peak-time-techno": { category: "Electronic", loudnessTrimDb: -6.79, overrides: { kick: { volume: 0.99 }, bass: { volume: 0.96 }, fx: { volume: 0.78 } } },
  ...
  "progressive-house": { category: "Electronic", loudnessTrimDb: -4.49, overrides: { lead: { volume: 0.8, sendA: 0.22 }, chords: { volume: 0.8, sendA: 0.22 } } },
  "progressive-trance": { category: "Electronic", loudnessTrimDb: -6.53, overrides: { lead: { volume: 0.84, sendA: 0.26 }, chords: { volume: 0.82, sendA: 0.26 } } },
  ...
  "raw-techno": { category: "Electronic", loudnessTrimDb: -2.97, overrides: { kick: { volume: 1.0 }, snare: { volume: 0.9 }, percussion: { volume: 0.8 } } },
  "riddim": { category: "Electronic", loudnessTrimDb: -1.03, overrides: { kick: { volume: 0.97 }, bass: { volume: 0.99 }, lead: { volume: 0.6 } } },
  ...
  "speedbass": { category: "Electronic", loudnessTrimDb: -3.62, overrides: { bass: { volume: 0.98 }, kick: { volume: 0.97 } } },
  "speed-garage": { category: "Electronic", loudnessTrimDb: 0, overrides: { hihat: { volume: 0.74, pan: -0.34, sendB: 0.2 }, bass: { volume: 0.94 } } },
  "synthwave": { category: "Electronic", loudnessTrimDb: -2.47, overrides: { snare: { volume: 0.88, sendA: 0.22 }, chords: { volume: 0.86, pan: -0.3, sendA: 0.2 }, lead: { volume: 0.84, pan: 0.3, sendA: 0.22 }, bass: { volume: 0.92 } }, duck: { duckDb: 5, releaseMs: 150 } }, // slow tempo and a sustained bass: a longer release keeps it from chopping
  "tearout-dubstep": { category: "Electronic", loudnessTrimDb: 0, overrides: { kick: { volume: 0.98 }, bass: { volume: 1.0 }, snare: { volume: 0.72 } } },
  "tech-house": { category: "Electronic", loudnessTrimDb: -0.07, overrides: { kick: { volume: 0.97 }, bass: { volume: 0.94 }, percussion: { volume: 0.76, sendB: 0.26 } } },
  "techstep": { category: "Electronic", loudnessTrimDb: 0, overrides: { kick: { volume: 0.94 }, snare: { volume: 0.92 }, bass: { volume: 0.98 } } },
  "tech-trance": { category: "Electronic", loudnessTrimDb: -7.43, overrides: { kick: { volume: 0.99 }, bass: { volume: 0.96 }, lead: { volume: 0.84, sendA: 0.24 } } },
  ...
  "uk-funky": { category: "Electronic", loudnessTrimDb: -0.02, overrides: { bass: { volume: 0.94 }, percussion: { volume: 0.82, pan: 0.4 } } },
  ...
  "uplifting-trance": { category: "Electronic", loudnessTrimDb: -6.95, overrides: { lead: { volume: 0.9, pan: 0.16, sendA: 0.28 }, chords: { volume: 0.84, pan: -0.16, sendA: 0.28 }, bass: { volume: 0.9 } } },
  ...
  "vocal-trance": { category: "Electronic", loudnessTrimDb: -6.6, overrides: { lead: { volume: 0.92, sendA: 0.28 }, chords: { volume: 0.82, sendA: 0.26 } } },
  ...
  "bebop": { humanise: 0.4, category: "Jazz/Blues", loudnessTrimDb: -7.31, overrides: { kick: { volume: 0.62, sendA: 0.08 }, snare: { volume: 0.66, sendA: 0.1 }, hihat: { volume: 0.56 }, percussion: { volume: 0.46 }, bass: { volume: 0.98 }, chords: { volume: 0.76, sendA: 0.14 }, lead: { volume: 0.84, sendA: 0.16 } }  }, // bebop comping is defined by accent, not by grid position
  ...
  "free-jazz": { category: "Jazz/Blues", loudnessTrimDb: -6.72, overrides: { kick: { volume: 0.68, sendA: 0.14 }, snare: { volume: 0.74, sendA: 0.16 }, hihat: { volume: 0.6, sendA: 0.14 }, percussion: { volume: 0.68, pan: 0.26 }, bass: { volume: 0.96 }, chords: { volume: 0.74, sendA: 0.2 }, lead: { volume: 0.84, sendA: 0.2 } } },
  ...
  "jazz-fusion": { category: "Jazz/Blues", loudnessTrimDb: -6.17, overrides: { kick: { volume: 0.86 }, snare: { volume: 0.84, sendA: 0.12 }, bass: { volume: 0.97 }, chords: { volume: 0.84, pan: -0.22, sendA: 0.14 }, lead: { volume: 0.82, pan: 0.22, sendA: 0.16 } } },
  ...
  "city-pop": { category: "Pop/R&B", loudnessTrimDb: -0.08, overrides: { snare: { volume: 0.86, sendA: 0.16 }, bass: { volume: 0.9 }, chords: { volume: 0.8, pan: -0.26, sendA: 0.2 }, lead: { volume: 0.84, pan: 0.26, sendA: 0.2 } } },
  ...
  "disco": { category: "Pop/R&B", loudnessTrimDb: -4.31, overrides: { snare: { volume: 0.86, sendA: 0.16 }, hihat: { volume: 0.7, pan: -0.28, sendB: 0.16 }, percussion: { volume: 0.8, pan: 0.4, sendB: 0.22 }, bass: { volume: 0.94 }, chords: { volume: 0.8, pan: -0.24, sendA: 0.2 }, lead: { volume: 0.82, pan: 0.24, sendA: 0.2 } }, duck: { duckDb: 5.5, releaseMs: 140 } }, // four-on-the-floor with a melodic bass line that has to come back between kicks
  "eurodance": { category: "Pop/R&B", loudnessTrimDb: -5.46, overrides: { kick: { volume: 0.96 }, bass: { volume: 0.94 }, chords: { volume: 0.82, sendA: 0.22 }, lead: { volume: 0.92, sendA: 0.24 }, fx: { volume: 0.72 } } },
  ...
  "k-pop": { category: "Pop/R&B", loudnessTrimDb: -5.96, overrides: { kick: { volume: 0.94 }, snare: { volume: 0.88 }, bass: { volume: 0.94 }, lead: { volume: 0.94, sendA: 0.2 }, fx: { volume: 0.74 } } },
  "motown": { humanise: 0.36, category: "Pop/R&B", loudnessTrimDb: -0.11, overrides: { kick: { volume: 0.76 }, snare: { volume: 0.78, sendA: 0.16 }, hihat: { volume: 0.56 }, percussion: { volume: 0.72, pan: 0.36 }, bass: { volume: 0.94 }, chords: { volume: 0.76, sendA: 0.16 }, lead: { volume: 0.92, pan: 0.1, sendA: 0.22 } }  }, // see soul — same rooms, same players
  ...
  "synth-pop": { category: "Pop/R&B", loudnessTrimDb: -5.83, overrides: { kick: { volume: 0.9 }, bass: { volume: 0.9 }, chords: { volume: 0.82, pan: -0.24, sendA: 0.18 }, lead: { volume: 0.9, pan: 0.2, sendA: 0.2 } } },
  "traditional-pop": { category: "Pop/R&B", loudnessTrimDb: -4.3, overrides: { kick: { volume: 0.66 }, snare: { volume: 0.62, sendA: 0.16 }, hihat: { volume: 0.48 }, percussion: { volume: 0.5 }, bass: { volume: 0.86 }, chords: { volume: 0.78, sendA: 0.2 }, lead: { volume: 0.94, sendA: 0.26 }, fx: { volume: 0.24 } } },
  ...
  "black-metal": { category: "Rock/Metal", loudnessTrimDb: 3, overrides: { kick: { volume: 0.96 }, snare: { volume: 0.94 }, hihat: { volume: 0.72 }, chords: { volume: 0.84, sendA: 0.14 }, lead: { volume: 0.78 } } },
  ...
  "death-metal": { category: "Rock/Metal", loudnessTrimDb: 2.75, overrides: { kick: { volume: 1.0 }, snare: { volume: 0.95 }, chords: { volume: 0.88, pan: -0.5 }, lead: { volume: 0.8, pan: 0.5 } } },
  ...
  "heavy-metal": { category: "Rock/Metal", loudnessTrimDb: 0, overrides: { kick: { volume: 0.96 }, snare: { volume: 0.93 }, chords: { volume: 0.9, pan: -0.5 }, lead: { volume: 0.84, pan: 0.5 } } },
  ...
  "metalcore": { category: "Rock/Metal", loudnessTrimDb: 1.75, overrides: { kick: { volume: 1.0 }, snare: { volume: 0.94 }, bass: { volume: 0.94 }, chords: { volume: 0.9, pan: -0.5 }, lead: { volume: 0.82, pan: 0.5 } } },
  "new-wave": { category: "Rock/Metal", loudnessTrimDb: -2.19, overrides: { kick: { volume: 0.86 }, snare: { volume: 0.84, sendA: 0.2 }, bass: { volume: 0.92 }, chords: { volume: 0.82, sendA: 0.16 }, lead: { volume: 0.84, sendA: 0.18 } } },
  "post-punk": { category: "Rock/Metal", loudnessTrimDb: -0.08, overrides: { kick: { volume: 0.88 }, snare: { volume: 0.86, sendA: 0.2 }, bass: { volume: 0.96 }, chords: { volume: 0.82, sendA: 0.18 }, lead: { volume: 0.76, sendA: 0.2 } } },
  ...
  "thrash-metal": { category: "Rock/Metal", loudnessTrimDb: 1.79, overrides: { kick: { volume: 0.98 }, snare: { volume: 0.96 }, hihat: { volume: 0.76 }, chords: { volume: 0.88, pan: -0.48 }, lead: { volume: 0.82, pan: 0.48 } } },
};
