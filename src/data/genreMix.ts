...
export const GENRE_MIX: Record<string, GenreMix> = {
  ...
  "acid-house": { category: "Electronic", loudnessTrimDb: -7.75 },
  "acid-techno": { category: "Electronic", loudnessTrimDb: -6.53 },
  ...
  "breakcore": { category: "Electronic", loudnessTrimDb: -3.92, overrides: { kick: { volume: 0.98 }, snare: { volume: 0.95 }, hihat: { volume: 0.82 }, percussion: { volume: 0.8 } } },
  "brooklyn-drill": { humanise: 0.12, category: "Electronic", loudnessTrimDb: -2.19, overrides: { hihat: { volume: 0.8, pan: -0.4, sendB: 0.18 }, bass: { volume: 0.97 }, lead: { volume: 0.62 } }  }, // drill hats are hyper-programmed; variation reads as sloppiness
  ...
  "chicago-house": { category: "Electronic", loudnessTrimDb: -5.53, overrides: { snare: { volume: 0.86, sendA: 0.14 }, chords: { volume: 0.78, sendA: 0.18 } } },
  ...
  "chiptune": { humanise: 0.07, category: "Electronic", loudnessTrimDb: -0.1, overrides: { hihat: { volume: 0.8 }, lead: { volume: 0.88, pan: 0.1 }, chords: { volume: 0.78 }, fx: { volume: 0.5 } }  }, // trackers are grid-locked and the chips have no velocity to speak of
  "deathstep": { category: "Electronic", loudnessTrimDb: -1.18, overrides: { kick: { volume: 0.98 }, bass: { volume: 0.98 }, snare: { volume: 0.7 } } },
  "deep-house": { category: "Electronic", loudnessTrimDb: -0.05, overrides: { hihat: { volume: 0.62, sendB: 0.2 }, bass: { volume: 0.94 }, chords: { volume: 0.82, sendA: 0.2 }, lead: { volume: 0.68 } } },
  "detroit-techno": { category: "Electronic", loudnessTrimDb: -5.84, overrides: { chords: { volume: 0.8, pan: -0.18, sendA: 0.2 }, lead: { volume: 0.74 } } },
  ...
  "drift-phonk": { humanise: 0.08, category: "Electronic", loudnessTrimDb: -1.81, overrides: { kick: { volume: 1.0 }, bass: { volume: 0.98 } }  }, // phonk is deliberately flat and loud — that is the aesthetic
  ...
  "edm-trap": { category: "Electronic", loudnessTrimDb: -0.43, overrides: { kick: { volume: 0.98 }, bass: { volume: 0.98 }, hihat: { volume: 0.82, pan: -0.38 }, lead: { volume: 0.8, sendA: 0.22 } } },
  "electro": { category: "Electronic", loudnessTrimDb: 0, overrides: { snare: { volume: 0.9 }, bass: { volume: 0.94 }, chords: { volume: 0.64 } } },
  "electro-house": { category: "Electronic", loudnessTrimDb: -3.55, overrides: { kick: { volume: 0.98 }, lead: { volume: 0.86, pan: 0.18 } } },
  "euro-trance": { category: "Electronic", loudnessTrimDb: -8.32, overrides: { lead: { volume: 0.9, sendA: 0.26 }, chords: { volume: 0.8, sendA: 0.28 }, fx: { volume: 0.72 } } },
  "footwork": { humanise: 0.12, category: "Electronic", loudnessTrimDb: -9, overrides: { kick: { volume: 0.98 }, snare: { volume: 0.8 }, hihat: { volume: 0.84, pan: -0.38 }, percussion: { volume: 0.8 } }, duck: { duckDb: 6.5, releaseMs: 80 } }, // at 160 BPM any humanisation reads as a mistake, not as feel · 160 BPM footwork: punch, not a swell
  ...
  "french-house": { category: "Electronic", loudnessTrimDb: -3.92, overrides: { bass: { volume: 0.94 }, chords: { volume: 0.8, sendA: 0.18 }, lead: { volume: 0.76, sendB: 0.22 } } },
  ...
  "future-house": { category: "Electronic", loudnessTrimDb: -4.41, overrides: { bass: { volume: 0.94 }, lead: { volume: 0.82, sendA: 0.2 } } },
  ...
  "goa-trance": { category: "Electronic", loudnessTrimDb: -4.18, overrides: { bass: { volume: 0.86 }, lead: { volume: 0.88, pan: 0.16, sendA: 0.24 }, chords: { volume: 0.82, sendA: 0.24 }, fx: { volume: 0.76 } } },
  ...
  "happy-hardcore": { category: "Electronic", loudnessTrimDb: -4.12, overrides: { kick: { volume: 0.98 }, lead: { volume: 0.86 }, chords: { volume: 0.78, sendA: 0.2 } } },
  "hardcore-gabber": { humanise: 0.07, category: "Electronic", loudnessTrimDb: -3.33, overrides: { kick: { volume: 1.0 }, snare: { volume: 0.7 }, bass: { volume: 0.94 } }, duck: { duckDb: 7, releaseMs: 70 } }, // the genre is defined by its machine-straight kick · a 170+ BPM kick arrives every ~170 ms, so the duck must clear before the next one
  "hardstyle": { humanise: 0.09, category: "Electronic", loudnessTrimDb: -5.01, overrides: { kick: { volume: 1.0 }, bass: { volume: 0.98 }, lead: { volume: 0.82 }, fx: { volume: 0.6 } }, duck: { duckDb: 7, releaseMs: 80 } }, // the reverse bass and kick are programmed, not played · the reverse bass is re-triggered on every kick, so the duck clears fast
  "hard-techno": { humanise: 0.1, category: "Electronic", loudnessTrimDb: -4.75, overrides: { kick: { volume: 1.0 }, bass: { volume: 0.95 }, snare: { volume: 0.86 } }, duck: { duckDb: 6.5, releaseMs: 110 } }, // industrial-weight techno: a flat kick is the point · harder and faster than the category base
  "hard-trance": { category: "Electronic", loudnessTrimDb: -1.91, overrides: { kick: { volume: 0.98 }, lead: { volume: 0.88, sendA: 0.22 } } },
  "hard-trap": { category: "Electronic", loudnessTrimDb: -0.07, overrides: { kick: { volume: 0.98 }, bass: { volume: 0.99 }, hihat: { volume: 0.8, pan: -0.4 } } },
  ...
  "idm": { category: "Electronic", loudnessTrimDb: -2.64, overrides: { percussion: { volume: 0.8, pan: 0.36 }, chords: { volume: 0.8, sendA: 0.24 }, bass: { volume: 0.88 } } },
  "industrial-techno": { humanise: 0.1, category: "Electronic", loudnessTrimDb: -4.7, overrides: { kick: { volume: 1.0 }, bass: { volume: 0.95 }, snare: { volume: 0.88 } }, duck: { duckDb: 6.5, releaseMs: 110 } }, // see hard-techno — the machine aesthetic is the genre · see hard-techno
  ...
  "jersey-drill": { category: "Electronic", loudnessTrimDb: -5.52, overrides: { kick: { volume: 0.98 }, bass: { volume: 0.98 }, hihat: { volume: 0.82, pan: -0.4 }, percussion: { volume: 0.78 } } },
  "jump-up": { category: "Electronic", loudnessTrimDb: 0, overrides: { kick: { volume: 0.98 }, snare: { volume: 0.92 }, bass: { volume: 0.98 } } },
  "jungle": { category: "Electronic", loudnessTrimDb: -2.44, overrides: { kick: { volume: 0.9 }, snare: { volume: 0.95 }, percussion: { volume: 0.82, pan: 0.44 }, bass: { volume: 0.96 } } },
  ...
  "liquid-dnb": { category: "Electronic", loudnessTrimDb: -1.38, overrides: { snare: { volume: 0.9, sendA: 0.16 }, bass: { volume: 0.94 }, chords: { volume: 0.8, sendA: 0.24 }, lead: { volume: 0.76, sendA: 0.22 } } },
  "lofi-house": { category: "Electronic", loudnessTrimDb: -8.8, overrides: { hihat: { volume: 0.58 }, chords: { volume: 0.84, sendA: 0.24 }, lead: { volume: 0.66, sendA: 0.22 }, fx: { volume: 0.34 } } },
  ...
  "melodic-house": { category: "Electronic", loudnessTrimDb: -0.12, overrides: { hihat: { volume: 0.62, sendB: 0.2 }, chords: { volume: 0.86, sendA: 0.22 }, lead: { volume: 0.76, sendA: 0.22 } } },
  ...
  "moombahton": { category: "Electronic", loudnessTrimDb: -2.06, overrides: { kick: { volume: 0.96 }, bass: { volume: 0.94 }, percussion: { volume: 0.82, pan: 0.42 } } },
  "neurofunk": { category: "Electronic", loudnessTrimDb: -4.56, overrides: { kick: { volume: 0.96 }, snare: { volume: 0.92 }, bass: { volume: 1.0 } } },
  "nu-disco-house": { category: "Electronic", loudnessTrimDb: -3.5, overrides: { bass: { volume: 0.92 }, chords: { volume: 0.8, pan: -0.2, sendA: 0.18 }, lead: { volume: 0.78 } } },
  "peak-time-techno": { category: "Electronic", loudnessTrimDb: -7.13, overrides: { kick: { volume: 0.99 }, bass: { volume: 0.96 }, fx: { volume: 0.78 } } },
  ...
  "progressive-house": { category: "Electronic", loudnessTrimDb: -6.21, overrides: { lead: { volume: 0.8, sendA: 0.22 }, chords: { volume: 0.8, sendA: 0.22 } } },
  "progressive-trance": { category: "Electronic", loudnessTrimDb: -8.61, overrides: { lead: { volume: 0.84, sendA: 0.26 }, chords: { volume: 0.82, sendA: 0.26 } } },
  "psytrance": { category: "Electronic", loudnessTrimDb: -1.67, overrides: { kick: { volume: 0.98 }, bass: { volume: 0.97 }, lead: { volume: 0.86, pan: 0.22 }, fx: { volume: 0.8 } } },
  "ragga-jungle": { category: "Electronic", loudnessTrimDb: -0.13, overrides: { kick: { volume: 0.88 }, snare: { volume: 0.92, sendA: 0.16 }, bass: { volume: 0.98 }, chords: { volume: 0.72 } } },
  "raw-techno": { category: "Electronic", loudnessTrimDb: -5.59, overrides: { kick: { volume: 1.0 }, snare: { volume: 0.9 }, percussion: { volume: 0.8 } } },
  "riddim": { category: "Electronic", loudnessTrimDb: -0.4, overrides: { kick: { volume: 0.97 }, bass: { volume: 0.99 }, lead: { volume: 0.6 } } },
  "sambass": { category: "Electronic", loudnessTrimDb: -1.71, overrides: { snare: { volume: 0.9 }, percussion: { volume: 0.92, pan: -0.42 }, bass: { volume: 0.92 } } },
  "schranz": { category: "Electronic", loudnessTrimDb: -0.01, overrides: { kick: { volume: 1.0 }, bass: { volume: 0.96 }, percussion: { volume: 0.82 } } },
  "speedbass": { category: "Electronic", loudnessTrimDb: -3.66, overrides: { bass: { volume: 0.98 }, kick: { volume: 0.97 } } },
  "speed-garage": { category: "Electronic", loudnessTrimDb: -3.47, overrides: { hihat: { volume: 0.74, pan: -0.34, sendB: 0.2 }, bass: { volume: 0.94 } } },
  "synthwave": { category: "Electronic", loudnessTrimDb: -3.25, overrides: { snare: { volume: 0.88, sendA: 0.22 }, chords: { volume: 0.86, pan: -0.3, sendA: 0.2 }, lead: { volume: 0.84, pan: 0.3, sendA: 0.22 }, bass: { volume: 0.92 } }, duck: { duckDb: 5, releaseMs: 150 } }, // slow tempo and a sustained bass: a longer release keeps it from chopping
  "tearout-dubstep": { category: "Electronic", loudnessTrimDb: 0, overrides: { kick: { volume: 0.98 }, bass: { volume: 1.0 }, snare: { volume: 0.72 } } },
  "tech-house": { category: "Electronic", loudnessTrimDb: -5.05, overrides: { kick: { volume: 0.97 }, bass: { volume: 0.94 }, percussion: { volume: 0.76, sendB: 0.26 } } },
  "techstep": { category: "Electronic", loudnessTrimDb: 0, overrides: { kick: { volume: 0.94 }, snare: { volume: 0.92 }, bass: { volume: 0.98 } } },
  "tech-trance": { category: "Electronic", loudnessTrimDb: -9, overrides: { kick: { volume: 0.99 }, bass: { volume: 0.96 }, lead: { volume: 0.84, sendA: 0.24 } } },
  ...
  "tropical-house": { category: "Electronic", loudnessTrimDb: -0.15, overrides: { percussion: { volume: 0.82, pan: 0.42 }, chords: { volume: 0.78, sendA: 0.2 }, lead: { volume: 0.74, sendA: 0.2 } } },
  ...
  "uplifting-trance": { category: "Electronic", loudnessTrimDb: -9, overrides: { lead: { volume: 0.9, pan: 0.16, sendA: 0.28 }, chords: { volume: 0.84, pan: -0.16, sendA: 0.28 }, bass: { volume: 0.9 } } },
  ...
  "vocal-trance": { category: "Electronic", loudnessTrimDb: -9, overrides: { lead: { volume: 0.92, sendA: 0.28 }, chords: { volume: 0.82, sendA: 0.26 } } },
  ...
  "southern-hip-hop": { category: "Hip Hop", loudnessTrimDb: -0.01, overrides: { kick: { volume: 0.98 }, snare: { volume: 0.8 }, hihat: { volume: 0.74 }, bass: { volume: 0.99 }, chords: { volume: 0.72, sendA: 0.2 }, lead: { volume: 0.7, sendA: 0.2 } } },
  ...
  // --------------------------------------------------------------- Jazz/Blues
  "acid-jazz": { category: "Jazz/Blues", loudnessTrimDb: -1.69, overrides: { kick: { volume: 0.86 }, snare: { volume: 0.84, sendA: 0.12 }, bass: { volume: 0.96 }, chords: { volume: 0.82, pan: -0.2 }, lead: { volume: 0.8, pan: 0.2 }, fx: { volume: 0.36, sendA: 0.12 } } },
  "bebop": { humanise: 0.4, category: "Jazz/Blues", loudnessTrimDb: -7.34, overrides: { kick: { volume: 0.62, sendA: 0.08 }, snare: { volume: 0.66, sendA: 0.1 }, hihat: { volume: 0.56 }, percussion: { volume: 0.46 }, bass: { volume: 0.98 }, chords: { volume: 0.76, sendA: 0.14 }, lead: { volume: 0.84, sendA: 0.16 } }  }, // bebop comping is defined by accent, not by grid position
  "chicago-blues": { humanise: 0.42, category: "Jazz/Blues", loudnessTrimDb: -5.34, overrides: { kick: { volume: 0.78 }, snare: { volume: 0.8, sendA: 0.14 }, bass: { volume: 0.92 }, chords: { volume: 0.84, pan: -0.22 }, lead: { volume: 0.86, pan: 0.22, sendA: 0.2 } }, duck: { duckDb: 5.5, releaseMs: 110 } }, // a live band — the whole idiom is dynamics · an acoustic bass and a played kick: gentle and quick
  ...
  "hard-bop": { category: "Jazz/Blues", loudnessTrimDb: -2.74, overrides: { kick: { volume: 0.7, sendA: 0.1 }, snare: { volume: 0.78, sendA: 0.12 }, hihat: { volume: 0.6 }, bass: { volume: 0.96 }, chords: { volume: 0.8, sendA: 0.16 }, lead: { volume: 0.85, sendA: 0.18 } } },
  "jazz-fusion": { category: "Jazz/Blues", loudnessTrimDb: -6.92, overrides: { kick: { volume: 0.86 }, snare: { volume: 0.84, sendA: 0.12 }, bass: { volume: 0.97 }, chords: { volume: 0.84, pan: -0.22, sendA: 0.14 }, lead: { volume: 0.82, pan: 0.22, sendA: 0.16 } } },
  "modal-jazz": { category: "Jazz/Blues", loudnessTrimDb: -1.56, overrides: { kick: { volume: 0.6 }, snare: { volume: 0.64, sendA: 0.12 }, hihat: { volume: 0.58 }, bass: { volume: 0.96 }, chords: { volume: 0.84, sendA: 0.18 }, lead: { volume: 0.78, sendA: 0.18 } } },
  ...
  "traditional-jazz": { category: "Jazz/Blues", loudnessTrimDb: -2.61, overrides: { kick: { volume: 0.66 }, snare: { volume: 0.72, sendA: 0.14 }, hihat: { volume: 0.52 }, percussion: { volume: 0.58, pan: 0.28 }, bass: { volume: 0.94 }, chords: { volume: 0.84, sendA: 0.18 }, lead: { volume: 0.8, sendA: 0.18 } } },
  ...
  "city-pop": { category: "Pop/R&B", loudnessTrimDb: -2.75, overrides: { snare: { volume: 0.86, sendA: 0.16 }, bass: { volume: 0.9 }, chords: { volume: 0.8, pan: -0.26, sendA: 0.2 }, lead: { volume: 0.84, pan: 0.26, sendA: 0.2 } } },
  ...
  "disco": { category: "Pop/R&B", loudnessTrimDb: -6.56, overrides: { snare: { volume: 0.86, sendA: 0.16 }, hihat: { volume: 0.7, pan: -0.28, sendB: 0.16 }, percussion: { volume: 0.8, pan: 0.4, sendB: 0.22 }, bass: { volume: 0.94 }, chords: { volume: 0.8, pan: -0.24, sendA: 0.2 }, lead: { volume: 0.82, pan: 0.24, sendA: 0.2 } }, duck: { duckDb: 5.5, releaseMs: 140 } }, // four-on-the-floor with a melodic bass line that has to come back between kicks
  "eurodance": { category: "Pop/R&B", loudnessTrimDb: -7.24, overrides: { kick: { volume: 0.96 }, bass: { volume: 0.94 }, chords: { volume: 0.82, sendA: 0.22 }, lead: { volume: 0.92, sendA: 0.24 }, fx: { volume: 0.72 } } },
  "funk": { humanise: 0.38, category: "Pop/R&B", loudnessTrimDb: 0, overrides: { kick: { volume: 0.94 }, snare: { volume: 0.9 }, hihat: { volume: 0.74 }, percussion: { volume: 0.76, pan: 0.38 }, bass: { volume: 0.98 }, chords: { volume: 0.74, pan: -0.22 }, lead: { volume: 0.78, pan: 0.22 } }  }, // the one is hard, the ghosts are barely there; that gap is the genre
  ...
  "k-pop": { category: "Pop/R&B", loudnessTrimDb: -8.98, overrides: { kick: { volume: 0.94 }, snare: { volume: 0.88 }, bass: { volume: 0.94 }, lead: { volume: 0.94, sendA: 0.2 }, fx: { volume: 0.74 } } },
  "motown": { humanise: 0.36, category: "Pop/R&B", loudnessTrimDb: -3.56, overrides: { kick: { volume: 0.76 }, snare: { volume: 0.78, sendA: 0.16 }, hihat: { volume: 0.56 }, percussion: { volume: 0.72, pan: 0.36 }, bass: { volume: 0.94 }, chords: { volume: 0.76, sendA: 0.16 }, lead: { volume: 0.92, pan: 0.1, sendA: 0.22 } }  }, // see soul — same rooms, same players
  ...
  "synth-pop": { category: "Pop/R&B", loudnessTrimDb: -6.77, overrides: { kick: { volume: 0.9 }, bass: { volume: 0.9 }, chords: { volume: 0.82, pan: -0.24, sendA: 0.18 }, lead: { volume: 0.9, pan: 0.2, sendA: 0.2 } } },
  "traditional-pop": { category: "Pop/R&B", loudnessTrimDb: -3.49, overrides: { kick: { volume: 0.66 }, snare: { volume: 0.62, sendA: 0.16 }, hihat: { volume: 0.48 }, percussion: { volume: 0.5 }, bass: { volume: 0.86 }, chords: { volume: 0.78, sendA: 0.2 }, lead: { volume: 0.94, sendA: 0.26 }, fx: { volume: 0.24 } } },
  ...
  "black-metal": { category: "Rock/Metal", loudnessTrimDb: 3.65, overrides: { kick: { volume: 0.96 }, snare: { volume: 0.94 }, hihat: { volume: 0.72 }, chords: { volume: 0.84, sendA: 0.14 }, lead: { volume: 0.78 } } },
  ...
  "death-metal": { category: "Rock/Metal", loudnessTrimDb: 1.08, overrides: { kick: { volume: 1.0 }, snare: { volume: 0.95 }, chords: { volume: 0.88, pan: -0.5 }, lead: { volume: 0.8, pan: 0.5 } } },
  ...
  "heavy-metal": { category: "Rock/Metal", loudnessTrimDb: 1.11, overrides: { kick: { volume: 0.96 }, snare: { volume: 0.93 }, chords: { volume: 0.9, pan: -0.5 }, lead: { volume: 0.84, pan: 0.5 } } },
  "math-rock": { category: "Rock/Metal", loudnessTrimDb: 0, overrides: { snare: { volume: 0.86, sendA: 0.12 }, chords: { volume: 0.88, pan: -0.4 }, lead: { volume: 0.86, pan: 0.4 }, fx: { volume: 0.36 } } },
  "metalcore": { category: "Rock/Metal", loudnessTrimDb: 2.03, overrides: { kick: { volume: 1.0 }, snare: { volume: 0.94 }, bass: { volume: 0.94 }, chords: { volume: 0.9, pan: -0.5 }, lead: { volume: 0.82, pan: 0.5 } } },
  "new-wave": { category: "Rock/Metal", loudnessTrimDb: -1.74, overrides: { kick: { volume: 0.86 }, snare: { volume: 0.84, sendA: 0.2 }, bass: { volume: 0.92 }, chords: { volume: 0.82, sendA: 0.16 }, lead: { volume: 0.84, sendA: 0.18 } } },
  ...
  "punk-rock": { category: "Rock/Metal", loudnessTrimDb: 0, overrides: { kick: { volume: 0.94 }, snare: { volume: 0.96 }, bass: { volume: 0.9 }, chords: { volume: 0.9, pan: -0.42 }, lead: { volume: 0.8, pan: 0.42 } } },
  ...
  "thrash-metal": { category: "Rock/Metal", loudnessTrimDb: 0.03, overrides: { kick: { volume: 0.98 }, snare: { volume: 0.96 }, hihat: { volume: 0.76 }, chords: { volume: 0.88, pan: -0.48 }, lead: { volume: 0.82, pan: 0.48 } } },
};
