...
export const GENRE_MIX: Record<string, GenreMix> = {
  ...
  "future-house": { category: "Electronic", loudnessTrimDb: -4.52, overrides: { bass: { volume: 0.94 }, lead: { volume: 0.82, sendA: 0.2 } } },
  ...
  "goa-trance": { category: "Electronic", loudnessTrimDb: -4.16, overrides: { bass: { volume: 0.86 }, lead: { volume: 0.88, pan: 0.16, sendA: 0.24 }, chords: { volume: 0.82, sendA: 0.24 }, fx: { volume: 0.76 } } },
  ...
  "jungle": { category: "Electronic", loudnessTrimDb: -2.39, overrides: { kick: { volume: 0.9 }, snare: { volume: 0.95 }, percussion: { volume: 0.82, pan: 0.44 }, bass: { volume: 0.96 } } },
  "kawaii-future-bass": { category: "Electronic", loudnessTrimDb: -0.01, overrides: { lead: { volume: 0.9, sendA: 0.22 }, chords: { volume: 0.8, sendA: 0.22 }, bass: { volume: 0.94 } } },
  "liquid-dnb": { category: "Electronic", loudnessTrimDb: -1.49, overrides: { snare: { volume: 0.9, sendA: 0.16 }, bass: { volume: 0.94 }, chords: { volume: 0.8, sendA: 0.24 }, lead: { volume: 0.76, sendA: 0.22 } } },
  "lofi-house": { category: "Electronic", loudnessTrimDb: -8.91, overrides: { hihat: { volume: 0.58 }, chords: { volume: 0.84, sendA: 0.24 }, lead: { volume: 0.66, sendA: 0.22 }, fx: { volume: 0.34 } } },
  ...
  "moombahton": { category: "Electronic", loudnessTrimDb: -0.23, overrides: { kick: { volume: 0.96 }, bass: { volume: 0.94 }, percussion: { volume: 0.82, pan: 0.42 } } },
  "neurofunk": { category: "Electronic", loudnessTrimDb: -4.56, overrides: { kick: { volume: 0.96 }, snare: { volume: 0.92 }, bass: { volume: 1.0 } } },
  "nu-disco-house": { category: "Electronic", loudnessTrimDb: -2.66, overrides: { bass: { volume: 0.92 }, chords: { volume: 0.8, pan: -0.2, sendA: 0.18 }, lead: { volume: 0.78 } } },
  "peak-time-techno": { category: "Electronic", loudnessTrimDb: -7.17, overrides: { kick: { volume: 0.99 }, bass: { volume: 0.96 }, fx: { volume: 0.78 } } },
  ...
  "progressive-house": { category: "Electronic", loudnessTrimDb: -5.61, overrides: { lead: { volume: 0.8, sendA: 0.22 }, chords: { volume: 0.8, sendA: 0.22 } } },
  "progressive-trance": { category: "Electronic", loudnessTrimDb: -8.55, overrides: { lead: { volume: 0.84, sendA: 0.26 }, chords: { volume: 0.82, sendA: 0.26 } } },
  "psytrance": { category: "Electronic", loudnessTrimDb: -1.76, overrides: { kick: { volume: 0.98 }, bass: { volume: 0.97 }, lead: { volume: 0.86, pan: 0.22 }, fx: { volume: 0.8 } } },
  ...
  "raw-techno": { category: "Electronic", loudnessTrimDb: -5.39, overrides: { kick: { volume: 1.0 }, snare: { volume: 0.9 }, percussion: { volume: 0.8 } } },
  "riddim": { category: "Electronic", loudnessTrimDb: -0.4, overrides: { kick: { volume: 0.97 }, bass: { volume: 0.99 }, lead: { volume: 0.6 } } },
  "sambass": { category: "Electronic", loudnessTrimDb: -1.75, overrides: { snare: { volume: 0.9 }, percussion: { volume: 0.92, pan: -0.42 }, bass: { volume: 0.92 } } },
  ...
  "tropical-house": { category: "Electronic", loudnessTrimDb: -0.03, overrides: { percussion: { volume: 0.82, pan: 0.42 }, chords: { volume: 0.78, sendA: 0.2 }, lead: { volume: 0.74, sendA: 0.2 } } },
  ...
  "hard-bop": { category: "Jazz/Blues", loudnessTrimDb: -2.99, overrides: { kick: { volume: 0.7, sendA: 0.1 }, snare: { volume: 0.78, sendA: 0.12 }, hihat: { volume: 0.6 }, bass: { volume: 0.96 }, chords: { volume: 0.8, sendA: 0.16 }, lead: { volume: 0.85, sendA: 0.18 } } },
  "jazz-fusion": { category: "Jazz/Blues", loudnessTrimDb: -6.95, overrides: { kick: { volume: 0.86 }, snare: { volume: 0.84, sendA: 0.12 }, bass: { volume: 0.97 }, chords: { volume: 0.84, pan: -0.22, sendA: 0.14 }, lead: { volume: 0.82, pan: 0.22, sendA: 0.16 } } },
  "modal-jazz": { category: "Jazz/Blues", loudnessTrimDb: -1.32, overrides: { kick: { volume: 0.6 }, snare: { volume: 0.64, sendA: 0.12 }, hihat: { volume: 0.58 }, bass: { volume: 0.96 }, chords: { volume: 0.84, sendA: 0.18 }, lead: { volume: 0.78, sendA: 0.18 } } },
  ...
  "samba": { category: "Latin/World", loudnessTrimDb: -0.03, overrides: { percussion: { volume: 1.0, pan: -0.44, sendB: 0.2 }, bass: { volume: 0.9 }, chords: { volume: 0.74, pan: 0.2 }, lead: { volume: 0.78 } } },
  ...
  "black-metal": { category: "Rock/Metal", loudnessTrimDb: 1.53, overrides: { kick: { volume: 0.96 }, snare: { volume: 0.94 }, hihat: { volume: 0.72 }, chords: { volume: 0.84, sendA: 0.14 }, lead: { volume: 0.78 } } },
  ...
  "death-metal": { category: "Rock/Metal", loudnessTrimDb: 1.09, overrides: { kick: { volume: 1.0 }, snare: { volume: 0.95 }, chords: { volume: 0.88, pan: -0.5 }, lead: { volume: 0.8, pan: 0.5 } } },
