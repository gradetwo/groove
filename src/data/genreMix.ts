...
export const GENRE_MIX: Record<string, GenreMix> = {
  ...
  "acid-house": { category: "Electronic", loudnessTrimDb: -2.41 },
  "acid-techno": { category: "Electronic", loudnessTrimDb: -1.15 },
  ...
  "brostep": { humanise: 0.12, category: "Electronic", loudnessTrimDb: -0.45, overrides: { kick: { volume: 0.98 }, bass: { volume: 0.98, sendA: 0.0 } }  }, // see dubstep
  ...
  "dubstep": { humanise: 0.12, category: "Electronic", loudnessTrimDb: 0.55, overrides: { kick: { volume: 0.98 }, snare: { volume: 0.72 }, bass: { volume: 0.99 }, chords: { volume: 0.6 }, lead: { volume: 0.64 }, fx: { volume: 0.6 } }  }, // the dynamics live in the sound design, not in the lane levels
  ...
  "euro-trance": { category: "Electronic", loudnessTrimDb: -3.38, overrides: { lead: { volume: 0.9, sendA: 0.26 }, chords: { volume: 0.8, sendA: 0.28 }, fx: { volume: 0.72 } } },
  "footwork": { humanise: 0.12, category: "Electronic", loudnessTrimDb: -2.81, overrides: { kick: { volume: 0.98 }, snare: { volume: 0.8 }, hihat: { volume: 0.84, pan: -0.38 }, percussion: { volume: 0.8 } }, duck: { duckDb: 6.5, releaseMs: 80 } }, // at 160 BPM any humanisation reads as a mistake, not as feel · 160 BPM footwork: punch, not a swell
  ...
  "lofi-house": { category: "Electronic", loudnessTrimDb: -4.5, overrides: { hihat: { volume: 0.58 }, chords: { volume: 0.84, sendA: 0.24 }, lead: { volume: 0.66, sendA: 0.22 }, fx: { volume: 0.34 } } },
  ...
  "neurofunk": { category: "Electronic", loudnessTrimDb: -0.2, overrides: { kick: { volume: 0.96 }, snare: { volume: 0.92 }, bass: { volume: 1.0 } } },
  ...
  "riddim": { category: "Electronic", loudnessTrimDb: 0.81, overrides: { kick: { volume: 0.97 }, bass: { volume: 0.99 }, lead: { volume: 0.6 } } },
  ...
  "tech-trance": { category: "Electronic", loudnessTrimDb: -4.57, overrides: { kick: { volume: 0.99 }, bass: { volume: 0.96 }, lead: { volume: 0.84, sendA: 0.24 } } },
  ...
  "uk-funky": { category: "Electronic", loudnessTrimDb: -0.01, overrides: { bass: { volume: 0.94 }, percussion: { volume: 0.82, pan: 0.4 } } },
  ...
  "uplifting-trance": { category: "Electronic", loudnessTrimDb: -4.62, overrides: { lead: { volume: 0.9, pan: 0.16, sendA: 0.28 }, chords: { volume: 0.84, pan: -0.16, sendA: 0.28 }, bass: { volume: 0.9 } } },
  ...
  "vocal-trance": { category: "Electronic", loudnessTrimDb: -2.63, overrides: { lead: { volume: 0.92, sendA: 0.28 }, chords: { volume: 0.82, sendA: 0.26 } } },
  ...
  "bebop": { humanise: 0.4, category: "Jazz/Blues", loudnessTrimDb: -0.17, overrides: { kick: { volume: 0.62, sendA: 0.08 }, snare: { volume: 0.66, sendA: 0.1 }, hihat: { volume: 0.56 }, percussion: { volume: 0.46 }, bass: { volume: 0.98 }, chords: { volume: 0.76, sendA: 0.14 }, lead: { volume: 0.84, sendA: 0.16 } }  }, // bebop comping is defined by accent, not by grid position
  ...
  "eurodance": { category: "Pop/R&B", loudnessTrimDb: -0.06, overrides: { kick: { volume: 0.96 }, bass: { volume: 0.94 }, chords: { volume: 0.82, sendA: 0.22 }, lead: { volume: 0.92, sendA: 0.24 }, fx: { volume: 0.72 } } },
  ...
  "heavy-metal": { category: "Rock/Metal", loudnessTrimDb: 1.58, overrides: { kick: { volume: 0.96 }, snare: { volume: 0.93 }, chords: { volume: 0.9, pan: -0.5 }, lead: { volume: 0.84, pan: 0.5 } } },
  "math-rock": { category: "Rock/Metal", loudnessTrimDb: 0.48, overrides: { snare: { volume: 0.86, sendA: 0.12 }, chords: { volume: 0.88, pan: -0.4 }, lead: { volume: 0.86, pan: 0.4 }, fx: { volume: 0.36 } } },
  "metalcore": { category: "Rock/Metal", loudnessTrimDb: 2.33, overrides: { kick: { volume: 1.0 }, snare: { volume: 0.94 }, bass: { volume: 0.94 }, chords: { volume: 0.9, pan: -0.5 }, lead: { volume: 0.82, pan: 0.5 } } },
  ...
  "post-punk": { category: "Rock/Metal", loudnessTrimDb: 0.07, overrides: { kick: { volume: 0.88 }, snare: { volume: 0.86, sendA: 0.2 }, bass: { volume: 0.96 }, chords: { volume: 0.82, sendA: 0.18 }, lead: { volume: 0.76, sendA: 0.2 } } },
  ...
  "punk-rock": { category: "Rock/Metal", loudnessTrimDb: 0.4, overrides: { kick: { volume: 0.94 }, snare: { volume: 0.96 }, bass: { volume: 0.9 }, chords: { volume: 0.9, pan: -0.42 }, lead: { volume: 0.8, pan: 0.42 } } },
