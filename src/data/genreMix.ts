...
export const GENRE_MIX: Record<string, GenreMix> = {
  ...
  "acid-techno": { category: "Electronic", loudnessTrimDb: -1.11 },
  "afro-house": { category: "Electronic", loudnessTrimDb: 0, overrides: { percussion: { volume: 0.8, pan: -0.45, sendB: 0.26 } } },
  "ambient": { humanise: 0.45, category: "Electronic", loudnessTrimDb: -1.54, overrides: { kick: { volume: 0.5, sendA: 0.2 }, snare: { volume: 0.42, sendA: 0.22 }, hihat: { volume: 0.38, pan: -0.34 }, percussion: { volume: 0.34 }, bass: { volume: 0.78 }, chords: { volume: 0.92, sendA: 0.38 }, lead: { volume: 0.68, sendA: 0.34 }, fx: { volume: 0.24, sendA: 0.3 } }, duck: { duckDb: 4, releaseMs: 280 } }, // almost nothing here is on the grid; the pads are played and breathe · there is no pumping here — a slow swell under a rare kick
  ...
  "brostep": { humanise: 0.12, category: "Electronic", loudnessTrimDb: -2.67, overrides: { kick: { volume: 0.98 }, bass: { volume: 0.98, sendA: 0.0 } }  }, // see dubstep
  ...
  "dream-trance": { category: "Electronic", loudnessTrimDb: -0.03, overrides: { lead: { volume: 0.88, sendA: 0.3 }, chords: { volume: 0.84, sendA: 0.3 } } },
  "drift-phonk": { humanise: 0.08, category: "Electronic", loudnessTrimDb: 0, overrides: { kick: { volume: 1.0 }, bass: { volume: 0.98 } }  }, // phonk is deliberately flat and loud — that is the aesthetic
  ...
  "euro-trance": { category: "Electronic", loudnessTrimDb: -2.59, overrides: { lead: { volume: 0.9, sendA: 0.26 }, chords: { volume: 0.8, sendA: 0.28 }, fx: { volume: 0.72 } } },
  "footwork": { humanise: 0.12, category: "Electronic", loudnessTrimDb: -2.64, overrides: { kick: { volume: 0.98 }, snare: { volume: 0.8 }, hihat: { volume: 0.84, pan: -0.38 }, percussion: { volume: 0.8 } }, duck: { duckDb: 6.5, releaseMs: 80 } }, // at 160 BPM any humanisation reads as a mistake, not as feel · 160 BPM footwork: punch, not a swell
  "frenchcore": { humanise: 0.07, category: "Electronic", loudnessTrimDb: -0.07, overrides: { kick: { volume: 1.0 }, lead: { volume: 0.72 }, fx: { volume: 0.5 } }, duck: { duckDb: 7, releaseMs: 70 } }, // same as gabber: the kick is the genre, and it does not move · see hardcore-gabber — the tempo sets the release
  "french-house": { category: "Electronic", loudnessTrimDb: -0.03, overrides: { bass: { volume: 0.94 }, chords: { volume: 0.8, sendA: 0.18 }, lead: { volume: 0.76, sendB: 0.22 } } },
  ...
  "hardcore-gabber": { humanise: 0.07, category: "Electronic", loudnessTrimDb: -2.66, overrides: { kick: { volume: 1.0 }, snare: { volume: 0.7 }, bass: { volume: 0.94 } }, duck: { duckDb: 7, releaseMs: 70 } }, // the genre is defined by its machine-straight kick · a 170+ BPM kick arrives every ~170 ms, so the duck must clear before the next one
  ...
  "hard-trap": { category: "Electronic", loudnessTrimDb: 0, overrides: { kick: { volume: 0.98 }, bass: { volume: 0.99 }, hihat: { volume: 0.8, pan: -0.4 } } },
  ...
  "lofi-house": { category: "Electronic", loudnessTrimDb: -4.46, overrides: { hihat: { volume: 0.58 }, chords: { volume: 0.84, sendA: 0.24 }, lead: { volume: 0.66, sendA: 0.22 }, fx: { volume: 0.34 } } },
  ...
  "neurofunk": { category: "Electronic", loudnessTrimDb: -0.34, overrides: { kick: { volume: 0.96 }, snare: { volume: 0.92 }, bass: { volume: 1.0 } } },
  ...
  "peak-time-techno": { category: "Electronic", loudnessTrimDb: -0.06, overrides: { kick: { volume: 0.99 }, bass: { volume: 0.96 }, fx: { volume: 0.78 } } },
  ...
  "riddim": { category: "Electronic", loudnessTrimDb: 0.92, overrides: { kick: { volume: 0.97 }, bass: { volume: 0.99 }, lead: { volume: 0.6 } } },
  ...
  "tech-trance": { category: "Electronic", loudnessTrimDb: -4.32, overrides: { kick: { volume: 0.99 }, bass: { volume: 0.96 }, lead: { volume: 0.84, sendA: 0.24 } } },
  ...
  "uplifting-trance": { category: "Electronic", loudnessTrimDb: -3.65, overrides: { lead: { volume: 0.9, pan: 0.16, sendA: 0.28 }, chords: { volume: 0.84, pan: -0.16, sendA: 0.28 }, bass: { volume: 0.9 } } },
  ...
  "vocal-trance": { category: "Electronic", loudnessTrimDb: -2.62, overrides: { lead: { volume: 0.92, sendA: 0.28 }, chords: { volume: 0.82, sendA: 0.26 } } },
  ...
  "bossa-nova": { category: "Latin/World", loudnessTrimDb: -0.09, overrides: { kick: { volume: 0.5 }, snare: { volume: 0.46, sendA: 0.12 }, hihat: { volume: 0.48 }, percussion: { volume: 0.72, pan: -0.3 }, bass: { volume: 0.9 }, chords: { volume: 0.9, pan: 0.18, sendA: 0.22 }, lead: { volume: 0.8, sendA: 0.22 }, fx: { volume: 0.2 } } },
  ...
  "k-pop": { category: "Pop/R&B", loudnessTrimDb: -3.78, overrides: { kick: { volume: 0.94 }, snare: { volume: 0.88 }, bass: { volume: 0.94 }, lead: { volume: 0.94, sendA: 0.2 }, fx: { volume: 0.74 } } },
  ...
  "synth-pop": { category: "Pop/R&B", loudnessTrimDb: -0.65, overrides: { kick: { volume: 0.9 }, bass: { volume: 0.9 }, chords: { volume: 0.82, pan: -0.24, sendA: 0.18 }, lead: { volume: 0.9, pan: 0.2, sendA: 0.2 } } },
  ...
  "black-metal": { category: "Rock/Metal", loudnessTrimDb: 2.78, overrides: { kick: { volume: 0.96 }, snare: { volume: 0.94 }, hihat: { volume: 0.72 }, chords: { volume: 0.84, sendA: 0.14 }, lead: { volume: 0.78 } } },
  "blues-rock": { category: "Rock/Metal", loudnessTrimDb: -1.18, overrides: { kick: { volume: 0.88 }, snare: { volume: 0.88, sendA: 0.16 }, bass: { volume: 0.9 }, chords: { volume: 0.84 }, lead: { volume: 0.9, sendA: 0.18 } } },
  ...
  "doom-metal": { category: "Rock/Metal", loudnessTrimDb: -2.43, overrides: { kick: { volume: 0.92 }, snare: { volume: 0.84, sendA: 0.26 }, bass: { volume: 0.98 }, chords: { volume: 0.9, sendA: 0.2 }, lead: { volume: 0.76, sendA: 0.22 } } },
  "grunge": { category: "Rock/Metal", loudnessTrimDb: -0.94, overrides: { kick: { volume: 0.88 }, snare: { volume: 0.9, sendA: 0.18 }, chords: { volume: 0.88 }, lead: { volume: 0.78 } } },
  ...
  "post-punk": { category: "Rock/Metal", loudnessTrimDb: -0.16, overrides: { kick: { volume: 0.88 }, snare: { volume: 0.86, sendA: 0.2 }, bass: { volume: 0.96 }, chords: { volume: 0.82, sendA: 0.18 }, lead: { volume: 0.76, sendA: 0.2 } } },
