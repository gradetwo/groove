...
| next | **P1.2b — the mid band is a mix claim**: raise the lanes that inhabit 200 Hz–2 kHz (chords, lead, the snare's body) where the band is thin, under the same `genreMix` table that carries P0.3's duck. P0.9's re-record absorbs the level change, which is why the two belong in one round. | — |
