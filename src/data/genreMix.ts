...
export const GENRE_MIX: Record<string, GenreMix> = {
  ...
  "euro-trance": { category: "Electronic", loudnessTrimDb: -3.27, overrides: { lead: { volume: 0.9, sendA: 0.26 }, chords: { volume: 0.8, sendA: 0.28 }, fx: { volume: 0.72 } } },
  "footwork": { humanise: 0.12, category: "Electronic", loudnessTrimDb: -2.74, overrides: { kick: { volume: 0.98 }, snare: { volume: 0.8 }, hihat: { volume: 0.84, pan: -0.38 }, percussion: { volume: 0.8 } }, duck: { duckDb: 6.5, releaseMs: 80 } }, // at 160 BPM any humanisation reads as a mistake, not as feel · 160 BPM footwork: punch, not a swell
  ...
  "lofi-house": { category: "Electronic", loudnessTrimDb: -4.45, overrides: { hihat: { volume: 0.58 }, chords: { volume: 0.84, sendA: 0.24 }, lead: { volume: 0.66, sendA: 0.22 }, fx: { volume: 0.34 } } },
  ...
  "neurofunk": { category: "Electronic", loudnessTrimDb: -0.09, overrides: { kick: { volume: 0.96 }, snare: { volume: 0.92 }, bass: { volume: 1.0 } } },
  ...
  "tech-trance": { category: "Electronic", loudnessTrimDb: -4.38, overrides: { kick: { volume: 0.99 }, bass: { volume: 0.96 }, lead: { volume: 0.84, sendA: 0.24 } } },
