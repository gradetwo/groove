...
export const GENRE_MIX: Record<string, GenreMix> = {
  ...
  "dubstep": { humanise: 0.12, category: "Electronic", loudnessTrimDb: 0, overrides: { kick: { volume: 0.98 }, snare: { volume: 0.72 }, bass: { volume: 0.99 }, chords: { volume: 0.6 }, lead: { volume: 0.64 }, fx: { volume: 0.6 } }  }, // the dynamics live in the sound design, not in the lane levels
  ...
  "synthwave": { category: "Electronic", loudnessTrimDb: -2.46, overrides: { snare: { volume: 0.88, sendA: 0.22 }, chords: { volume: 0.86, pan: -0.3, sendA: 0.2 }, lead: { volume: 0.84, pan: 0.3, sendA: 0.22 }, bass: { volume: 0.92 } }, duck: { duckDb: 5, releaseMs: 150 } }, // slow tempo and a sustained bass: a longer release keeps it from chopping
