...
export const GENRE_MIX: Record<string, GenreMix> = {
  ...
  "acid-house": { category: "Electronic", loudnessTrimDb: -4.9 },
  "acid-techno": { category: "Electronic", loudnessTrimDb: -3.47 },
  ...
  "euro-trance": { category: "Electronic", loudnessTrimDb: -0.23, overrides: { lead: { volume: 0.9, sendA: 0.26 }, chords: { volume: 0.8, sendA: 0.28 }, fx: { volume: 0.72 } } },
  "footwork": { humanise: 0.12, category: "Electronic", loudnessTrimDb: -4.18, overrides: { kick: { volume: 0.98 }, snare: { volume: 0.8 }, hihat: { volume: 0.84, pan: -0.38 }, percussion: { volume: 0.8 } }, duck: { duckDb: 6.5, releaseMs: 80 } }, // at 160 BPM any humanisation reads as a mistake, not as feel · 160 BPM footwork: punch, not a swell
  ...
  "lofi-house": { category: "Electronic", loudnessTrimDb: -5.51, overrides: { hihat: { volume: 0.58 }, chords: { volume: 0.84, sendA: 0.24 }, lead: { volume: 0.66, sendA: 0.22 }, fx: { volume: 0.34 } } },
  ...
  "neurofunk": { category: "Electronic", loudnessTrimDb: -3.03, overrides: { kick: { volume: 0.96 }, snare: { volume: 0.92 }, bass: { volume: 1.0 } } },
  ...
  "synthwave": { category: "Electronic", loudnessTrimDb: 0, overrides: { snare: { volume: 0.88, sendA: 0.22 }, chords: { volume: 0.86, pan: -0.3, sendA: 0.2 }, lead: { volume: 0.84, pan: 0.3, sendA: 0.22 }, bass: { volume: 0.92 } }, duck: { duckDb: 5, releaseMs: 150 } }, // slow tempo and a sustained bass: a longer release keeps it from chopping
  ...
  "tech-trance": { category: "Electronic", loudnessTrimDb: -6.04, overrides: { kick: { volume: 0.99 }, bass: { volume: 0.96 }, lead: { volume: 0.84, sendA: 0.24 } } },
  ...
  "uplifting-trance": { category: "Electronic", loudnessTrimDb: -5.87, overrides: { lead: { volume: 0.9, pan: 0.16, sendA: 0.28 }, chords: { volume: 0.84, pan: -0.16, sendA: 0.28 }, bass: { volume: 0.9 } } },
  ...
  "vocal-trance": { category: "Electronic", loudnessTrimDb: -2.27, overrides: { lead: { volume: 0.92, sendA: 0.28 }, chords: { volume: 0.82, sendA: 0.26 } } },
  ...
  "bebop": { humanise: 0.4, category: "Jazz/Blues", loudnessTrimDb: -0.03, overrides: { kick: { volume: 0.62, sendA: 0.08 }, snare: { volume: 0.66, sendA: 0.1 }, hihat: { volume: 0.56 }, percussion: { volume: 0.46 }, bass: { volume: 0.98 }, chords: { volume: 0.76, sendA: 0.14 }, lead: { volume: 0.84, sendA: 0.16 } }  }, // bebop comping is defined by accent, not by grid position
  ...
  "k-pop": { category: "Pop/R&B", loudnessTrimDb: -2.22, overrides: { kick: { volume: 0.94 }, snare: { volume: 0.88 }, bass: { volume: 0.94 }, lead: { volume: 0.94, sendA: 0.2 }, fx: { volume: 0.74 } } },
  ...
  "synth-pop": { category: "Pop/R&B", loudnessTrimDb: 0, overrides: { kick: { volume: 0.9 }, bass: { volume: 0.9 }, chords: { volume: 0.82, pan: -0.24, sendA: 0.18 }, lead: { volume: 0.9, pan: 0.2, sendA: 0.2 } } },
